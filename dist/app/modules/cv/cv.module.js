...
CvModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forFeature([{ name: 'TimeLine', schema: time_line_schema_1.TimeLineSchema }]),
            mongoose_1.MongooseModule.forFeature([{ name: 'Point', schema: point_schema_1.PointSchema }]),
        ],
